// $ANTLR !Unknown version! jj.g 2013-11-06 23:09:26

package Compilador;
import Compilador.Semanticator;
import Compilador.Function;
import Compilador.Entrys;
...
public class jjParser extends Parser {
    ...
    // delegators
        ...
        public jjParser(TokenStream input, RecognizerSharedState state) {
            super(input, state);
             
        }
        

    public String[] getTokenNames() { return jjParser.tokenNames; }
    public String getGrammarFileName() { return "jj.g"; }
    ...
    // $ANTLR start "javax"
    // jj.g:100:1: javax : ( ( vardecl SEMI )* ( stat ) )+ ;
    public final void javax() throws RecognitionException {
        try {
            // jj.g:101:2: ( ( ( vardecl SEMI )* ( stat ) )+ )
            // jj.g:101:4: ( ( vardecl SEMI )* ( stat ) )+
            {
            // jj.g:101:4: ( ( vardecl SEMI )* ( stat ) )+
            int cnt2=0;
            loop2:
            do {
                ...
                switch (alt2) {
            	case 1 :
            	    // jj.g:101:5: ( vardecl SEMI )* ( stat )
            	    {
            	    // jj.g:101:5: ( vardecl SEMI )*
            	    loop1:
            	    do {
            	        int alt1=2;
    ...
    // $ANTLR start "stat"
    // jj.g:104:1: stat : ( def_func | def_chest );
    public final void stat() throws RecognitionException {
        try {
            // jj.g:105:2: ( def_func | def_chest )
            int alt3=2;
    ...
    // jj.g:109:1: weakstat returns [ String type ] : ( varatrib SEMI | vardecl SEMI | funccall SEMI | def_if | def_while | t= def_return SEMI | chestaccess SEMI | def_repeat );
    public final String weakstat() throws RecognitionException {
        ...
        try {
            // jj.g:110:2: ( varatrib SEMI | vardecl SEMI | funccall SEMI | def_if | def_while | t= def_return SEMI | chestaccess SEMI | def_repeat )
            int alt4=8;
            alt4 = dfa4.predict(input);
            switch (alt4) {
                case 1 :
                    // jj.g:110:4: varatrib SEMI
                    {
    ...
    // jj.g:120:1: varatrib : n= NAME ASSIGN t= logic_op_expr ;
    public final void varatrib() throws RecognitionException {
        ...
        try {
            // jj.g:121:2: (n= NAME ASSIGN t= logic_op_expr )
            // jj.g:121:5: n= NAME ASSIGN t= logic_op_expr
            {
    ...
    // $ANTLR start "vardecl"
    // jj.g:124:1: vardecl : t= type v= NAME ( COMMA v= NAME )* ;
    public final void vardecl() throws RecognitionException {
        ...
        try {
            // jj.g:125:2: (t= type v= NAME ( COMMA v= NAME )* )
            // jj.g:125:5: t= type v= NAME ( COMMA v= NAME )*
            {
    ...
    // jj.g:128:1: funccall returns [ String type ] : n= NAME LPAREN h= arglist RPAREN ;
    public final String funccall() throws RecognitionException {
        ...
        try {
            // jj.g:129:2: (n= NAME LPAREN h= arglist RPAREN )
            // jj.g:129:5: n= NAME LPAREN h= arglist RPAREN
            {
    ...
    // jj.g:132:1: def_func : t= type n= NAME LPAREN h= typedarglist RPAREN (tw= weakstat )* END ;
    public final void def_func() throws RecognitionException {
        ...
        try {
            // jj.g:133:2: (t= type n= NAME LPAREN h= typedarglist RPAREN (tw= weakstat )* END )
            // jj.g:133:5: t= type n= NAME LPAREN h= typedarglist RPAREN (tw= weakstat )* END
            {
    ...
    // $ANTLR start "def_if"
    // jj.g:137:1: def_if : IF logic_op_expr THEN ( weakstat )* ( END | ( ELSE ( weakstat )* END ) ) ;
    public final void def_if() throws RecognitionException {
        try {
            // jj.g:138:2: ( IF logic_op_expr THEN ( weakstat )* ( END | ( ELSE ( weakstat )* END ) ) )
            // jj.g:138:5: IF logic_op_expr THEN ( weakstat )* ( END | ( ELSE ( weakstat )* END ) )
            {
            ...
            // jj.g:138:37: ( END | ( ELSE ( weakstat )* END ) )
            int alt9=2;
            ...
            switch (alt9) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // jj.g:138:45: ( ELSE ( weakstat )* END )
                    {
                    // jj.g:138:45: ( ELSE ( weakstat )* END )
                    // jj.g:138:47: ELSE ( weakstat )* END
                    {
                    match(input,ELSE,FOLLOW_ELSE_in_def_if953); 
                    // jj.g:138:52: ( weakstat )*
                    loop8:
                    do {
                        int alt8=2;
    ...
    // jj.g:141:1: def_repeat : REPEAT ( weakstat )* UNTIL LPAREN logic_op_expr RPAREN END ;
    public final void def_repeat() throws RecognitionException {
        try {
            // jj.g:142:2: ( REPEAT ( weakstat )* UNTIL LPAREN logic_op_expr RPAREN END )
            // jj.g:142:5: REPEAT ( weakstat )* UNTIL LPAREN logic_op_expr RPAREN END
            {
            match(input,REPEAT,FOLLOW_REPEAT_in_def_repeat976); 
            // jj.g:142:12: ( weakstat )*
            loop10:
            do {
                int alt10=2;
    ...
    // jj.g:145:1: def_chest : CHEST NAME COLON ( vardecl SEMI | funccall SEMI )* END ;
    public final void def_chest() throws RecognitionException {
        try {
            // jj.g:146:2: ( CHEST NAME COLON ( vardecl SEMI | funccall SEMI )* END )
            // jj.g:146:4: CHEST NAME COLON ( vardecl SEMI | funccall SEMI )* END
            {
            ...
            // jj.g:146:21: ( vardecl SEMI | funccall SEMI )*
            loop11:
            do {
                int alt11=3;
    ...
    // jj.g:149:1: def_while : WHILE LPAREN logic_op_expr RPAREN ( weakstat )* END ;
    public final void def_while() throws RecognitionException {
        try {
            // jj.g:150:2: ( WHILE LPAREN logic_op_expr RPAREN ( weakstat )* END )
            // jj.g:150:4: WHILE LPAREN logic_op_expr RPAREN ( weakstat )* END
            {
    ...
    // $ANTLR start "type"
    // jj.g:154:1: type returns [ String type ] : ( T_INT | T_REAL | T_STRING | T_BOOL | T_VOID | T_CHAIN );
    public final String type() throws RecognitionException {
        String type = null;

        try {
            // jj.g:155:2: ( T_INT | T_REAL | T_STRING | T_BOOL | T_VOID | T_CHAIN )
            int alt13=6;
            switch ( input.LA(1) ) {
            case T_INT:
                {
    ...
    // $ANTLR start "term"
    // jj.g:163:1: term returns [ String type ] : (v= variable | f= funccall | n= number | str= string );
    public final String term() throws RecognitionException {
        ...
        try {
            // jj.g:164:2: (v= variable | f= funccall | n= number | str= string )
            int alt14=4;
            switch ( input.LA(1) ) {
            case NAME:
                {
    ...
    // jj.g:170:1: unary_op_expr returns [ String type ] : ( MINUS | PLUS | NOT )? t= term ;
    public final String unary_op_expr() throws RecognitionException {
        ...
        try {
            // jj.g:171:2: ( ( MINUS | PLUS | NOT )? t= term )
            // jj.g:171:4: ( MINUS | PLUS | NOT )? t= term
            {
            // jj.g:171:4: ( MINUS | PLUS | NOT )?
            int alt15=2;
    ...
    // jj.g:174:1: strong_op_expr returns [ String type ] : t1= unary_op_expr (op= ( STAR | SLASH | PERCENT ) t2= unary_op_expr )* ;
    public final String strong_op_expr() throws RecognitionException {
        ...
        try {
            // jj.g:175:2: (t1= unary_op_expr (op= ( STAR | SLASH | PERCENT ) t2= unary_op_expr )* )
            // jj.g:175:4: t1= unary_op_expr (op= ( STAR | SLASH | PERCENT ) t2= unary_op_expr )*
            {
            ...
            type = t1;
            // jj.g:175:34: (op= ( STAR | SLASH | PERCENT ) t2= unary_op_expr )*
            loop16:
            do {
                int alt16=2;
                ...
                switch (alt16) {
            	case 1 :
            	    // jj.g:175:36: op= ( STAR | SLASH | PERCENT ) t2= unary_op_expr
            	    {
            	    op=(Token)input.LT(1);
    ...
    // jj.g:178:1: weak_op_expr returns [ String type ] : (t1= strong_op_expr (op= ( PLUS | MINUS ) t2= strong_op_expr )* | FALSE | TRUE );
    public final String weak_op_expr() throws RecognitionException {
        ...
        try {
            // jj.g:179:2: (t1= strong_op_expr (op= ( PLUS | MINUS ) t2= strong_op_expr )* | FALSE | TRUE )
            int alt18=3;
            switch ( input.LA(1) ) {
            case PLUS:
            case MINUS:
            ...
            switch (alt18) {
                case 1 :
                    // jj.g:179:4: t1= strong_op_expr (op= ( PLUS | MINUS ) t2= strong_op_expr )*
                    {
                    ...
                    state._fsp--;
                     ...
                     type =t1;
                    // jj.g:179:35: (op= ( PLUS | MINUS ) t2= strong_op_expr )*
                    loop17:
                    do {
                        int alt17=2;
                        ...
                        switch (alt17) {
                    	case 1 :
                    	    // jj.g:179:37: op= ( PLUS | MINUS ) t2= strong_op_expr
                    	    {
                    	    op=(Token)input.LT(1);
    ...
    // jj.g:184:1: relational_op_expr returns [ String type ] : t1= weak_op_expr (op= ( LESS | GREATER | EQUAL | NOTEQUAL | GREATEREQUAL | LESSEQUAL ) t2= weak_op_expr )* ;
    public final String relational_op_expr() throws RecognitionException {
        ...
        try {
            // jj.g:185:2: (t1= weak_op_expr (op= ( LESS | GREATER | EQUAL | NOTEQUAL | GREATEREQUAL | LESSEQUAL ) t2= weak_op_expr )* )
            // jj.g:185:4: t1= weak_op_expr (op= ( LESS | GREATER | EQUAL | NOTEQUAL | GREATEREQUAL | LESSEQUAL ) t2= weak_op_expr )*
            {
            ...
            state._fsp--;
             ...
             type =t1;
            // jj.g:185:33: (op= ( LESS | GREATER | EQUAL | NOTEQUAL | GREATEREQUAL | LESSEQUAL ) t2= weak_op_expr )*
            loop19:
            do {
                int alt19=2;
                ...
                switch (alt19) {
            	case 1 :
            	    // jj.g:185:35: op= ( LESS | GREATER | EQUAL | NOTEQUAL | GREATEREQUAL | LESSEQUAL ) t2= weak_op_expr
            	    {
            	    op=(Token)input.LT(1);
    ...
    // jj.g:189:1: logic_op_expr returns [ String type ] : t1= relational_op_expr (op= ( OR | AND ) t2= relational_op_expr )* ;
    public final String logic_op_expr() throws RecognitionException {
        ...
        try {
            // jj.g:190:2: (t1= relational_op_expr (op= ( OR | AND ) t2= relational_op_expr )* )
            // jj.g:190:4: t1= relational_op_expr (op= ( OR | AND ) t2= relational_op_expr )*
            {
            ...
            type =t1;
            // jj.g:190:38: (op= ( OR | AND ) t2= relational_op_expr )*
            loop20:
            do {
                int alt20=2;
                ...
                switch (alt20) {
            	case 1 :
            	    // jj.g:190:40: op= ( OR | AND ) t2= relational_op_expr
            	    {
            	    op=(Token)input.LT(1);
    ...
    // jj.g:193:1: typedarglist returns [ HashMap<String,String> tamap ] : (t= type n= NAME ( COMMA t= type n= NAME )* )? ;
    public final HashMap<String,String> typedarglist() throws RecognitionException {
        ...
        try {
            // jj.g:194:2: ( (t= type n= NAME ( COMMA t= type n= NAME )* )? )
            // jj.g:194:3: (t= type n= NAME ( COMMA t= type n= NAME )* )?
            {
             tamap = new HashMap<String,String>(); 
            // jj.g:195:2: (t= type n= NAME ( COMMA t= type n= NAME )* )?
            int alt22=2;
            ...
            switch (alt22) {
                case 1 :
                    // jj.g:195:4: t= type n= NAME ( COMMA t= type n= NAME )*
                    {
                    ...
                    // jj.g:195:48: ( COMMA t= type n= NAME )*
                    loop21:
                    do {
                        int alt21=2;
                        ...
                        switch (alt21) {
                    	case 1 :
                    	    // jj.g:195:50: COMMA t= type n= NAME
                    	    {
    ...
    // jj.g:198:1: chestaccess : NAME ( DOT NAME )+ ;
    public final void chestaccess() throws RecognitionException {
        try {
            // jj.g:199:2: ( NAME ( DOT NAME )+ )
            // jj.g:199:4: NAME ( DOT NAME )+
            {
    ...
    // jj.g:202:1: def_return returns [ String type ] : RETURN t= logic_op_expr ;
    public final String def_return() throws RecognitionException {
        ...
        try {
            // jj.g:203:2: ( RETURN t= logic_op_expr )
            // jj.g:203:4: RETURN t= logic_op_expr
            {
    ...
    // $ANTLR start "arglist"
    // jj.g:206:1: arglist returns [ HashMap<String,String> amap ] : (n= NAME ( COMMA n1= NAME )* )? ;
    public final HashMap<String,String> arglist() throws RecognitionException {
        ...
        try {
            // jj.g:207:2: ( (n= NAME ( COMMA n1= NAME )* )? )
            // jj.g:207:3: (n= NAME ( COMMA n1= NAME )* )?
            {
             amap = new HashMap<String,String>(); 
            // jj.g:208:2: (n= NAME ( COMMA n1= NAME )* )?
            int alt25=2;
    ...
    // jj.g:211:1: variable returns [ String name ] : (n= NAME | chestaccess );
    public final String variable() throws RecognitionException {
        ...
        try {
            ...
            if ( (LA26_0==NAME) ) {
                ...
                else if ( (LA26_1==RPAREN||LA26_1==SEMI||(LA26_1>=PLUS && LA26_1<=SLASH)||(LA26_1>=LESS && LA26_1<=GREATER)||LA26_1==PERCENT||(LA26_1>=EQUAL && LA26_1<=OR)||LA26_1==THEN) ) {
                    alt26=1;
                }
                else {
                    NoViableAltException nvae =
    ...
    // $ANTLR start "number"
    // jj.g:216:1: number returns [ String type ] : ( INT | FLOAT );
    public final String number() throws RecognitionException {
        String type = null;

        try {
            // jj.g:217:2: ( INT | FLOAT )
            int alt27=2;
    ...
    // $ANTLR start "string"
    // jj.g:221:1: string returns [ String type ] : NORMALSTRING ;
    public final String string() throws RecognitionException {
        String type = null;

        try {
            // jj.g:222:2: ( NORMALSTRING )
            // jj.g:222:4: NORMALSTRING
            {
    ...
    static final String DFA4_acceptS =
        "\2\uffff\1\2\1\4\1\5\1\6\1\10\1\1\1\3\1\7";
    ...
    public static final BitSet FOLLOW_vardecl_in_javax681 = new BitSet(new long[]{0x0000000000000400L});
    public static final BitSet FOLLOW_SEMI_in_javax683 = new BitSet(new long[]{0x001FA00000000000L});
    public static final BitSet FOLLOW_stat_in_javax687 = new BitSet(new long[]{0x001FA00000000002L});
    ...
    public static final BitSet FOLLOW_varatrib_in_weakstat725 = new BitSet(new long[]{0x0000000000000400L});
    public static final BitSet FOLLOW_SEMI_in_weakstat727 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_vardecl_in_weakstat733 = new BitSet(new long[]{0x0000000000000400L});
    public static final BitSet FOLLOW_SEMI_in_weakstat739 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_funccall_in_weakstat745 = new BitSet(new long[]{0x0000000000000400L});
    ...
    public static final BitSet FOLLOW_def_return_in_weakstat773 = new BitSet(new long[]{0x0000000000000400L});
    public static final BitSet FOLLOW_SEMI_in_weakstat777 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_chestaccess_in_weakstat783 = new BitSet(new long[]{0x0000000000000400L});
    ...
    public static final BitSet FOLLOW_NAME_in_varatrib809 = new BitSet(new long[]{0x0000000000080000L});
    public static final BitSet FOLLOW_ASSIGN_in_varatrib811 = new BitSet(new long[]{0x01E00000E0003000L});
    public static final BitSet FOLLOW_logic_op_expr_in_varatrib815 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_type_in_vardecl831 = new BitSet(new long[]{0x0020000000000000L});
    public static final BitSet FOLLOW_NAME_in_vardecl835 = new BitSet(new long[]{0x0000000000000202L});
    public static final BitSet FOLLOW_COMMA_in_vardecl841 = new BitSet(new long[]{0x0020000000000000L});
    public static final BitSet FOLLOW_NAME_in_vardecl845 = new BitSet(new long[]{0x0000000000000202L});
    public static final BitSet FOLLOW_NAME_in_funccall870 = new BitSet(new long[]{0x0000000000000010L});
    public static final BitSet FOLLOW_LPAREN_in_funccall872 = new BitSet(new long[]{0x0020000000000020L});
    public static final BitSet FOLLOW_arglist_in_funccall876 = new BitSet(new long[]{0x0000000000000020L});
    public static final BitSet FOLLOW_RPAREN_in_funccall878 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_type_in_def_func896 = new BitSet(new long[]{0x0020000000000000L});
    public static final BitSet FOLLOW_NAME_in_def_func900 = new BitSet(new long[]{0x0000000000000010L});
    public static final BitSet FOLLOW_LPAREN_in_def_func902 = new BitSet(new long[]{0x001F800000000020L});
    public static final BitSet FOLLOW_typedarglist_in_def_func906 = new BitSet(new long[]{0x0000000000000020L});
    public static final BitSet FOLLOW_RPAREN_in_def_func908 = new BitSet(new long[]{0x003FB81C00000000L});
    public static final BitSet FOLLOW_weakstat_in_def_func918 = new BitSet(new long[]{0x003FB81C00000000L});
    public static final BitSet FOLLOW_END_in_def_func923 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_IF_in_def_if936 = new BitSet(new long[]{0x01E00000E0003000L});
    public static final BitSet FOLLOW_logic_op_expr_in_def_if938 = new BitSet(new long[]{0x0000400000000000L});
    public static final BitSet FOLLOW_THEN_in_def_if940 = new BitSet(new long[]{0x003FB83C00000000L});
    public static final BitSet FOLLOW_weakstat_in_def_if942 = new BitSet(new long[]{0x003FB83C00000000L});
    public static final BitSet FOLLOW_END_in_def_if947 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ELSE_in_def_if953 = new BitSet(new long[]{0x003FB81C00000000L});
    public static final BitSet FOLLOW_weakstat_in_def_if955 = new BitSet(new long[]{0x003FB81C00000000L});
    public static final BitSet FOLLOW_END_in_def_if958 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_REPEAT_in_def_repeat976 = new BitSet(new long[]{0x003FB09C00000000L});
    public static final BitSet FOLLOW_weakstat_in_def_repeat978 = new BitSet(new long[]{0x003FB09C00000000L});
    public static final BitSet FOLLOW_UNTIL_in_def_repeat981 = new BitSet(new long[]{0x0000000000000010L});
    public static final BitSet FOLLOW_LPAREN_in_def_repeat983 = new BitSet(new long[]{0x01E00000E0003000L});
    public static final BitSet FOLLOW_logic_op_expr_in_def_repeat985 = new BitSet(new long[]{0x0000000000000020L});
    public static final BitSet FOLLOW_RPAREN_in_def_repeat987 = new BitSet(new long[]{0x0000080000000000L});
    public static final BitSet FOLLOW_END_in_def_repeat989 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_CHEST_in_def_chest1001 = new BitSet(new long[]{0x0020000000000000L});
    public static final BitSet FOLLOW_NAME_in_def_chest1003 = new BitSet(new long[]{0x0000000000000100L});
    public static final BitSet FOLLOW_COLON_in_def_chest1005 = new BitSet(new long[]{0x003FA80000000000L});
    public static final BitSet FOLLOW_vardecl_in_def_chest1009 = new BitSet(new long[]{0x0000000000000400L});
    public static final BitSet FOLLOW_SEMI_in_def_chest1011 = new BitSet(new long[]{0x003FA80000000000L});
    public static final BitSet FOLLOW_funccall_in_def_chest1015 = new BitSet(new long[]{0x0000000000000400L});
    public static final BitSet FOLLOW_SEMI_in_def_chest1017 = new BitSet(new long[]{0x003FA80000000000L});
    public static final BitSet FOLLOW_END_in_def_chest1022 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_WHILE_in_def_while1033 = new BitSet(new long[]{0x0000000000000010L});
    public static final BitSet FOLLOW_LPAREN_in_def_while1035 = new BitSet(new long[]{0x01E00000E0003000L});
    public static final BitSet FOLLOW_logic_op_expr_in_def_while1037 = new BitSet(new long[]{0x0000000000000020L});
    public static final BitSet FOLLOW_RPAREN_in_def_while1039 = new BitSet(new long[]{0x003FB81C00000000L});
    public static final BitSet FOLLOW_weakstat_in_def_while1041 = new BitSet(new long[]{0x003FB81C00000000L});
    ...
    public static final BitSet FOLLOW_set_in_unary_op_expr1163 = new BitSet(new long[]{0x01E0000020003000L});
    public static final BitSet FOLLOW_term_in_unary_op_expr1180 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_unary_op_expr_in_strong_op_expr1199 = new BitSet(new long[]{0x000000000010C002L});
    public static final BitSet FOLLOW_set_in_strong_op_expr1206 = new BitSet(new long[]{0x01E0000020003000L});
    public static final BitSet FOLLOW_unary_op_expr_in_strong_op_expr1222 = new BitSet(new long[]{0x000000000010C002L});
    public static final BitSet FOLLOW_strong_op_expr_in_weak_op_expr1244 = new BitSet(new long[]{0x0000000000003002L});
    public static final BitSet FOLLOW_set_in_weak_op_expr1252 = new BitSet(new long[]{0x01E0000020003000L});
    public static final BitSet FOLLOW_strong_op_expr_in_weak_op_expr1264 = new BitSet(new long[]{0x0000000000003002L});
    ...
    public static final BitSet FOLLOW_weak_op_expr_in_relational_op_expr1298 = new BitSet(new long[]{0x0000000007860002L});
    public static final BitSet FOLLOW_set_in_relational_op_expr1306 = new BitSet(new long[]{0x01E00000E0003000L});
    public static final BitSet FOLLOW_weak_op_expr_in_relational_op_expr1334 = new BitSet(new long[]{0x0000000007860002L});
    public static final BitSet FOLLOW_relational_op_expr_in_logic_op_expr1357 = new BitSet(new long[]{0x0000000018000002L});
    public static final BitSet FOLLOW_set_in_logic_op_expr1365 = new BitSet(new long[]{0x01E00000E0003000L});
    public static final BitSet FOLLOW_relational_op_expr_in_logic_op_expr1377 = new BitSet(new long[]{0x0000000018000002L});
    public static final BitSet FOLLOW_type_in_typedarglist1404 = new BitSet(new long[]{0x0020000000000000L});
    public static final BitSet FOLLOW_NAME_in_typedarglist1408 = new BitSet(new long[]{0x0000000000000202L});
    public static final BitSet FOLLOW_COMMA_in_typedarglist1413 = new BitSet(new long[]{0x001F800000000000L});
    public static final BitSet FOLLOW_type_in_typedarglist1417 = new BitSet(new long[]{0x0020000000000000L});
    public static final BitSet FOLLOW_NAME_in_typedarglist1421 = new BitSet(new long[]{0x0000000000000202L});
    public static final BitSet FOLLOW_NAME_in_chestaccess1441 = new BitSet(new long[]{0x0000000000000800L});
    public static final BitSet FOLLOW_DOT_in_chestaccess1445 = new BitSet(new long[]{0x0020000000000000L});
    public static final BitSet FOLLOW_NAME_in_chestaccess1447 = new BitSet(new long[]{0x0000000000000802L});
    public static final BitSet FOLLOW_RETURN_in_def_return1466 = new BitSet(new long[]{0x01E00000E0003000L});
    public static final BitSet FOLLOW_logic_op_expr_in_def_return1470 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_NAME_in_arglist1495 = new BitSet(new long[]{0x0000000000000202L});
    public static final BitSet FOLLOW_COMMA_in_arglist1500 = new BitSet(new long[]{0x0020000000000000L});
    public static final BitSet FOLLOW_NAME_in_arglist1504 = new BitSet(new long[]{0x0000000000000202L});
